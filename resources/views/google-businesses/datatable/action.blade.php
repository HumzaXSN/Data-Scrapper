...
<div class="modal fade google-business-delete-modal-sm-{{$googleBusiness->id}}"
   ...
   <div class="modal-content">
       <div class="modal-header">
           <h6 class="modal-title" id="mySmallModalLabel">
               Delete
               <strong>{{ $googleBusiness->company }}</strong></h6>
       ...
       <div class="modal-body">
           ...
           <form action="{{url('google-businesses/'.$googleBusiness->id)}}"
               method="post">
               @csrf
               @method('DELETE')
