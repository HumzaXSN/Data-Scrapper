                        ...
                        <div class="mb-4 card card-shadow">
                            <div class="card-header mb-3">
                                <div class="card-title">
                                    Update Contact
                                    <a class="btn btn-danger" style="float: right" href="{{ route('contacts.index') }}">
                                        Skip </a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="{{ route('update-contacts-page') }}" method="post">
                                            @csrf
                                            @if (isset($failures))
                                                <table id="editable" class="table data-table">
                                                    <thead>
                                                        <tr>
                                                            <th>First Name</th>
                                                            <th>Last Name</th>
                                                        ...
                                                        @foreach ($failures as $failure)
                                                            <tr>
                                                                ...
                                                                <td> <input class="form-control" type="text"
                                                                        name="lname[]" placeholder="Enter Lastname"
                                                                ...
                                                                <td> <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ $failure[0]['state'] }}" required>
                                                                </td>
                                                                ...
                                                                <td> <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ $failure[0]['linkedin_profile'] }}">
                                                                </td>
                                                                <td> <select class="form-control" name="industry_id[]">
                                                                        @if ($failure[0]['industry'] == 'Healthcare')
                                                                            <option value="2" selected hidden>Healthcare
                                                                            </option>
                                                                        @endif
                                                                        @if ($failure[0]['industry'] == 'Software House')
                                                                            <option value="3" selected hidden>Software House
                                                                            </option>
                                                                        @endif
                                                    ...
                                                    <tbody>
                                                        @foreach ($arr as $data)
                                                            <tr>
                                                                <td>
                                                                    <input
                                                                        class="form-control @if ($data['first_name'] == null) is-invalid @endif"
                                                                        type="text" name="fname[]"
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="industry_id[]">
                                                                        <option class="d-none"
                                                                            value="{{ $data['industry_id'] }}">Selected
                                                                        </option>
                                                                        @foreach ($industry as $industries)
                                                                            <option value="{{ $industries->id }}">
                                                                                {{ $industries->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                            </tr>
